...
def calculate_average(row):
    ...
    try:
        parz2_value = int(parz2_totale.split('/')[0]) if pd.notna(parz2_totale) else None
    except AttributeError:
        parz2_value = None
...
num_students_above_18_Parz1 = df['Parz1_numeric'].dropna().apply(lambda x: x > 18).sum()

# Count how many students have a Parz2 score greater than 18
num_students_above_18_Parz2 = df['Parz2_numeric'].dropna().apply(lambda x: x > 18).sum()

# Print the results
print(f"Number of students with a final average score greater than 18: {num_students_above_18}")
print(f"Number of students with Parz1 score greater than 18: {num_students_above_18_Parz1}")
print(f"Number of students with Parz2 score greater than 18: {num_students_above_18_Parz2}")
...
# Count how many students have a final average score greater than 18
num_students_above_18_Parz1 = df['Parz1'].dropna().apply(lambda x: x > 18).sum()

# Count how many students have a final average score greater than 18
num_students_above_18_Parz2 = df['Parz2/totale'].dropna().apply(lambda x: x > 18).sum()

# Print the result tot
print(f"Number of students with a final average score greater than 18: {num_students_above_18}")
